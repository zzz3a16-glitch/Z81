...
export class NotificationService {
  ...
  getIconForType(type) {
    const icons = {
      ...
      [NOTIFICATION_TYPES.NEW_LIBRARY_CONTENT]: '🎬',
      [NOTIFICATION_TYPES.RECOMMENDATION]: '💡',
      [NOTIFICATION_TYPES.RESUME_REMINDER]: '⏯️',
      [NOTIFICATION_TYPES.SCAN_COMPLETED]: '✅',
      [NOTIFICATION_TYPES.NEW_EPISODES_FOUND]: '🆕',
      [NOTIFICATION_TYPES.FILE_MISSING]: '⚠️',
      [NOTIFICATION_TYPES.TMDB_UPDATED]: '🔄',
