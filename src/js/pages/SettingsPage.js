...
export async function SettingsPage(params) {
  ...
  container.innerHTML = `
    <div class="container" style="padding-top: 24px; padding-bottom: 40px;">
      <h1 style="font-size: 2rem; font-weight: 700; margin-bottom: 24px;">⚙️ الإعدادات</h1>
    ...
    <div style="display: grid; gap: 20px;">
      <div>
        ...
        <ul style="list-style: none; display: grid; gap: 8px; font-size: 14px; color: var(--color-text-secondary);">
          <li style="display: flex; align-items: center; gap: 8px;"><span style="color: var(--color-success);">✓</span> تكامل حقيقي مع TMDB API</li>
          <li style="display: flex; align-items: center; gap: 8px;"><span style="color: var(--color-success);">✓</span> 8 مظاهر احترافية + منشئ مظاهر مخصص</li>
          <li style="display: flex; align-items: center; gap: 8px;"><span style="color: var(--color-success);">✓</span> محرك ذكاء وتوصيات ذكية</li>
          <li style="display: flex; align-items: center; gap: 8px;"><span style="color: var(--color-success);">✓</span> تتبع السلوك وملف الذوق</li>
          <li style="display: flex; align-items: center; gap: 8px;"><span style="color: var(--color-success);">✓</span> مشغل احترافي مع mpv</li>
          <li style="display: flex; align-items: center; gap: 8px;"><span style="color: var(--color-success);">✓</span> قوائم مشاهدة متقدمة</li>
          <li style="display: flex; align-items: center; gap: 8px;"><span style="color: var(--color-success);">✓</span> بحث ذكي ومساعد وسائط</li>
          <li style="display: flex; align-items: center; gap: 8px;"><span style="color: var(--color-success);">✓</span> إحصائيات وتحليلات متقدمة</li>
          <li style="display: flex; align-items: center; gap: 8px;"><span style="color: var(--color-success);">✓</span> نسخ احتياطي واستعادة آمنة</li>
          <li style="display: flex; align-items: center; gap: 8px;"><span style="color: var(--color-success);">✓</span> دعم كامل للعربية RTL</li>
        </ul>
      </div>
