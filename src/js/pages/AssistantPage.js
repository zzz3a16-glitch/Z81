...
export async function AssistantPage() {
  ...
  const addUserMessage = (text) => {
    ...
    div.innerHTML = `
      ...
      <div style="width: 36px; height: 36px; background: var(--color-surface); border: 1px solid var(--color-border); border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">👤</div>
    `;
